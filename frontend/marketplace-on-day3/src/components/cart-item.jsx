export default function CartItem({item, handleDelCart}) {
    return (
        <div className="grid grid-cols-5 auto-rows-1 gap-4">
            ...
            <button className="row-span-3 col-span-1 place-self-center hover:bg-pink-200 rounded-full" onClick={()=>handleDelCart(item._id)}><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
